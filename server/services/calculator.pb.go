...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // need define tag, tag started from 1, name use tag 1
...
type Person struct {
	...
	Age         int64                  `protobuf:"varint,2,opt,name=age,proto3" json:"age,omitempty"`        // sint32, sint64 is better than int32, int64 when value is negative
	Weight      float32                `protobuf:"fixed32,3,opt,name=weight,proto3" json:"weight,omitempty"` // float32
	Height      float64                `protobuf:"fixed64,4,opt,name=height,proto3" json:"height,omitempty"` // float64
	Active      bool                   `protobuf:"varint,5,opt,name=active,proto3" json:"active,omitempty"`
	PhoneNumber []string               `protobuf:"bytes,6,rep,name=phone_number,json=phoneNumber,proto3" json:"phone_number,omitempty"` // []string
	Gender      Gender                 `protobuf:"varint,7,opt,name=gender,proto3,enum=services.Gender" json:"gender,omitempty"`
	Countries   map[string]string      `protobuf:"bytes,8,rep,name=countries,proto3" json:"countries,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // map[string]string
	CreatedDate *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=created_date,json=createdDate,proto3" json:"created_date,omitempty"`                                                                  // *timestamppb.Timestamp
}
...
var file_calculator_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67,
